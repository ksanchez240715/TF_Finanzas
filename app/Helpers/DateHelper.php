...
class DateHelper
{
    ...
    public static function getConvertDate($string){
        $var = "";

        $var = Carbon::parse($string);
//        if (config('constants.GENERAL.DATABASE') == config('constants.DATABASES.MYSQL')){
//            $var = "DATE_FORMAT(".$string.",  '%Y-%m-%d')";
//        }else{
//            $var = "CONVERT(varchar,".$string.", 101)";
//        }
        return $var;
    }
