...
@section('component-title')
    ...
    @include('layouts.shared._breadcrumbs', [
                           ...
                           config('constants.BREADCRUMB_ITEMS.MODULES.GESTION_USUARIOS.ITEMS.ADMINISTRATIVE.UPDATE')
                           ]
                       ])
@endsection
@section('content')
    ...
    <div class="m-content">
        <div class="m-portlet m-portlet--mobile">
            ...
            <div class="m-portlet__body">
                {{ Form::model($model,['route' => 'manage.user.administrativos.post.edit','id' => 'edit-form','class'=>'m-form m-form--fit m-form--label-align-right','method' => 'POST']) }}
                {{ csrf_field() }}
                <div class="m-portlet__body">
                    {{ Form::hidden('typeEdit', $type) }}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="m-form__group-sub col-lg-4">
                            ...
                            {{ Form::select('roles[]', array(1 => 'Administrador', 2 => 'Asistente', 10 => 'Director general'), $roles, array('class' => 'form-control','id' => 'select-roles','multiple' => true,'required' => true)) }}
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="m-form__group-sub col-lg-2">
...
@section('component-js')
    ...
    <script src="{{ asset('js/pages/manage/users/administrative/edit.js') }}" type="text/javascript"></script>
@endsection
