    ...
    <div class="m-content">
        <div class="m-portlet m-portlet--mobile">
                ...
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">
                            Listado de Personal Personal Externo
                        </h3>
                    </div>
                </div>
                <div class="m-portlet__head-tools">
                    <ul class="m-portlet__nav">
                        <li class="m-portlet__nav-item">
                            <a href="#" class="btn btn-primary m-btn m-btn--air m-btn--icon">
                                <span>
                                    <i class="la la-plus"></i>
                                    <span>Agregar Personal Externo</span>
                                </span>
                            </a>
                        </li>
            ...
            <div class="m-portlet__body">
                ...
                <table class="table table-striped- table-bordered table-hover table-checkable" id="dt_external_researcher" >
                    <thead>
...
@section('component-js')
    ...
    <script src="{{ asset('js/pages/manage/users/external-researcher.js') }}" type="text/javascript"></script>
