    ...
    <div class="m-content">
        <div class="m-portlet m-portlet--mobile">
            ...
            <div class="m-portlet__body">
                ...
                <table class="table table-striped- table-bordered table-hover table-checkable" id="dt_student" >
                    <thead>
...
@section('component-js')
    ...
    <script src="{{ asset('js/pages/manage/users/student.js') }}" type="text/javascript"></script>
