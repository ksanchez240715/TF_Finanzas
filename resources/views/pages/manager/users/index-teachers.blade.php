    ...
    <div class="m-content">
        <div class="m-portlet m-portlet--mobile">
            ...
            <div class="m-portlet__body">
                ...
                <table class="table table-striped- table-bordered table-hover table-checkable" id="dt_tecahers" >
                    <thead>
...
@section('component-js')
    ...
    <script src="{{ asset('js/pages/manage/users/teacher.js') }}" type="text/javascript"></script>
